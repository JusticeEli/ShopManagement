...
public abstract class Hilt_GoodsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GoodsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((GoodsFragment_GeneratedInjector) this.generatedComponent()).injectGoodsFragment(UnsafeCasts.<GoodsFragment>unsafeCast(this));
  }
