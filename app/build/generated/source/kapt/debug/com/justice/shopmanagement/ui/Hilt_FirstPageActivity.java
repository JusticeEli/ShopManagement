...
public abstract class Hilt_FirstPageActivity extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FirstPageActivity() {
    super();
  }

  Hilt_FirstPageActivity(int contentLayoutId) {
  ...
  protected void inject() {
    ((FirstPageActivity_GeneratedInjector) this.generatedComponent()).injectFirstPageActivity(UnsafeCasts.<FirstPageActivity>unsafeCast(this));
  }
