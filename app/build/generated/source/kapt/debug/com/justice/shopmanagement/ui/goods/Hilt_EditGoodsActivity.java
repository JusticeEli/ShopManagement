...
public abstract class Hilt_EditGoodsActivity extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditGoodsActivity() {
    super();
  }

  Hilt_EditGoodsActivity(int contentLayoutId) {
  ...
  protected void inject() {
    ((EditGoodsActivity_GeneratedInjector) this.generatedComponent()).injectEditGoodsActivity(UnsafeCasts.<EditGoodsActivity>unsafeCast(this));
  }
