...
public abstract class Hilt_AddGoodsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddGoodsFragment() {
    super();
  }

  Hilt_AddGoodsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((AddGoodsFragment_GeneratedInjector) this.generatedComponent()).injectAddGoodsFragment(UnsafeCasts.<AddGoodsFragment>unsafeCast(this));
  }
